...
DATA.storyIntros = [
  ...
  /* ---- OPENINGS FOR THE NEW STATIONS -------------------------------- */
  { id:"peak_vow", for:["yamabushi","religious"], quest:"enlighten",
    text:"You blow the conch to the four peaks and set out on the shugyō — the wandering austerity — to walk until the mountain burns the last softness out of you." },
  { id:"sect_errand", for:["yamabushi","religious","wanderer"], quest:"pilgrimage",
    text:"The order sends you down from the heights with a sealed message and a blessing: carry word between the far temples while the warlords burn the roads between them." },
  { id:"grand_bout", for:["sumo","entertainer"], quest:"fortune",
    text:"A daimyō has proclaimed a grand tournament with a purse that could buy a village. You leave the shrine-ring and take to the road to answer it." },
  { id:"plague_road", for:["physician","artisan"], quest:"duty",
    text:"A sickness walks the Tōkaidō faster than any army. You pack your chest of remedies and go toward it, because someone must, and you are someone." },
  { id:"tea_summons", for:["tea_master","noble","artisan"], quest:"alliance",
    text:"Two warlords have agreed to meet — but only over tea, and only if you pour it. You travel to hold a peace in a bowl no wider than two hands." },
  { id:"last_song", for:["biwa","entertainer","religious"], quest:"omen",
    text:"A verse you never learned rises unbidden from your strings, naming a place you have never been. You follow the song to find out why it knows the way." },
  { id:"pirate_score", for:["pirate","criminal"], quest:"fortune",
    text:"Word of a treasure-junk run aground draws every knife on the coast. You beach your hull and go inland after it, where the sea cannot help you." },
  { id:"lost_lord", for:["horsemaster","warrior","noble"], quest:"revenge",
    text:"Your lord fell to a rival's ambush and his banner was taken as a trophy. You ride to take it back, or die trying — a horse under you and murder ahead." },
  { id:"jonin_contract", for:["jonin","criminal","warrior"], quest:"contract",
    text:"A lord has bought your service for a single season and a single, unspeakable task. You set out to see it done — or to decide, on the road, that you won't." },
  { id:"court_grudge", for:["exiled_noble","noble"], quest:"revenge",
    text:"A whispered slander cost you the capital. You walk the provinces gathering the leverage — a letter here, a witness there — to return and ruin the men who smiled." },
  { id:"chief_ambition", for:["bandit_chief","criminal","warrior"], quest:"unify",
    text:"Why should the highways bow to some distant lord and not to you? You come down from the passes with your ragged army and a fan, meaning to carve a domain of your own." },
];
