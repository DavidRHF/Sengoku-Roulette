...
**A woodblock-print look.** The whole interface is themed like a Hiroshige/Hokusai ukiyo-e print: an **aged cream washi** ground with paper grain and faint seigaiha waves, **sumi-ink outlines**, and flat **Prussian-blue / vermilion / straw-ochre / bamboo-green** pigments. Panels are ink-framed paper cards with brush-stroke titles and vermilion **hanko seals** (人 · 記 · 具); buttons are paper tags (the primary a vermilion seal); the **wheel** is a printed paper disc with ink-outlined pigment wedges and a sumi ensō hub; item/tool tiles are cream cards with ink borders; and the scene art is drawn on cream skies with Prussian-blue water and snow-white, signed with a little red cartouche.
